...
// 生成処理
//===========
CObjectBillboard* CObjectBillboard::Create(const char* pTexName, D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXCOLOR col, float fRadius)
{
	CObjectBillboard* pObject2D;
	pObject2D = new CObjectBillboard;
	//初期化
		//初期化
	if (FAILED(pObject2D->Init(pTexName, pos, rot, col, fRadius)))
	{
		delete pObject2D;
		return nullptr;
	}
...
// 初期化処理
//==================
HRESULT CObjectBillboard::Init(const char* pTexName, D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXCOLOR col, float fRadius)
{
	//デバイスの取得
...
// 設定処理
//=============
void CObjectBillboard::Set(D3DXVECTOR3 pos, D3DXVECTOR3 rot)
{
}
