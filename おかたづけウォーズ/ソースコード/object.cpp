...
CObject* CObject::m_apTop[static_cast<int>(Priority::Max)] = {};
CObject* CObject::m_apCur[static_cast<int>(Priority::Max)] = {};
		...
		{// pObjがＮＵＬＬじゃない
			...
			if (pObj->m_bDeath == true)
			{
				...
				{// 自分が最後尾なら
					...
					if (m_apCur[nCnt])
					{
						m_apCur[nCnt]->m_pNext = nullptr;	// 最後尾の次をNULLに
					}
				}
				else
				{// それ以外の中間地点なら
