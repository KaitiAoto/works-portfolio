...
public:
	...
	D3DXVECTOR3 GetOffPos(void) { return m_Offsetpos; }
	// 設定
	...
	void SetAlphaColor(float alpha) { m_forcedColor.a = alpha;}
	void SetColorAlpha(bool bUse) { m_bAlphaChange = bUse; if (bUse == false) { m_forcedColor.a = 1.0f; } }
...
private:
	...
	bool m_bAlphaChange;		// アルファ値のみ変えるかどうか
};
