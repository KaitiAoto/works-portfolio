...
HRESULT CTitleSelect::Init(D3DXVECTOR3 pos)
{
	...
	m_pCursor = CObject2D::Create("data\\TEXTURE\\select.png", m_pos, VECTOR3_NULL, D3DXVECTOR2(T_SELECT_X * 1.35f, T_SELECT_Y * 1.35f), 7);

	m_pSelect[SELECT_GAME] = CObject2D::Create("data\\TEXTURE\\start00.png", m_pos, VECTOR3_NULL, D3DXVECTOR2(T_SELECT_X, T_SELECT_Y), 8);
	m_pSelect[SELECT_END] = CObject2D::Create("data\\TEXTURE\\end00.png", D3DXVECTOR3(m_pos.x, m_pos.y + T_SELECT_Y, m_pos.z), VECTOR3_NULL, D3DXVECTOR2(T_SELECT_X, T_SELECT_Y), 8);
...
void CTitleSelect::Update(void)
{
	...
	for (int nCnt = 0; nCnt < SELECT_MAX; nCnt++)
	{
		...
		m_pSelect[nCnt]->SetSize(D3DXVECTOR2(T_SELECT_X * scale, T_SELECT_Y * scale));
	}
}
//===============================================
// 描画処理
