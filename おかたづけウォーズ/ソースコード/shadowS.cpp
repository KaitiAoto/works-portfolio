...
HRESULT CShadowS::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float fRadius)
{
	...
	m_pObj2D = CObject2D::Create("data\\TEXTURE\\shadow000.jpg", D3DXVECTOR3(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 0.0f), m_rot, D3DXVECTOR2(SCREEN_WIDTH, SCREEN_HEIGHT));
	...
	CObjectX::Init("data\\MODEL\\shadowS00.x", m_pos, m_rot);
